(function( $, ace ) {
	...
	// jQuery(document).ready(function ($){
		...
		$('#instant-snippet-execute').on('click', function() {
			...
			ajax(payload).success(function(resp) {
				$('#instant-snippet-output').slideDown().html(resp)
			}).error(function(err) {
				$('#instant-snippet-output').slideDown().html("").html(err.responseText)
			})
		...
		$(document).on('click', '#code-snippet-new-tab', function(e) {
			...
			ajax(ajaxData).success(function(resp) {
